...
**Spec:** `docs/specs/2026-04-13-ping-gg-patterns-design.md`
...
When picking up work from a prior session, check `docs/plans/`
...
| Committed Plan | Plan saved to `docs/plans/` — repo-persistent, visible across sessions. |
